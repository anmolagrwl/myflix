...
describe Video do
  ...
  describe "search_by_title" do
    ...
    it "returns an array with multiple videos if multiple videos titles contain the search query ordered by created at" do
      happy_gilmore = Video.create(title: 'Happy Gilmore', description: 'A rejected hockey player puts his skills to the golf course to save his grandmother\'s house.', created_at: 1.day.ago)
      haunted_house = Video.create(title: 'Haunted House', description: 'A terrifying movie.', created_at: 2.days.ago)
