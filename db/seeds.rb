...
dexter = Video.create(title: 'Dexter', description: 'A Miami police forensics expert moonlights as a serial killer of criminals whom he believes have escaped justice.', small_cover_url: '/tmp/dexter.jpg', large_cover_url: '/tmp/dexter_large.jpg')
...
# Review.create(user: User.find(1), video: dexter, rating: 5, description: "Best. Show. Ever.")
# Review.create(user: User.find(1), video: dexter, rating: 2, description: "Worst. Show. Ever.")
